...
public class LeaderboardShowcase : MonoBehaviour
{
    ...
    public void Load()
    {
        ...
        _playerScore = GameManager.Instance.Score;
        _playerScoreText.text = $"Twój wynik: {_playerScore}";

        Leaderboards.ChwilaNieuwagiLeaderboard.GetEntries(searchQuery, OnLeaderboardLoaded, ErrorCallback);
    ...
    public void Submit()
    {
        Leaderboards.ChwilaNieuwagiLeaderboard.UploadNewEntry(_playerUsernameInput.text, _playerScore, Callback, ErrorCallback);
    }

    public void DeleteEntry()
    {
        Leaderboards.ChwilaNieuwagiLeaderboard.DeleteEntry(Callback, ErrorCallback);
    }
    ...
    {
        Leaderboards.ChwilaNieuwagiLeaderboard.GetPersonalEntry(OnPersonalEntryLoaded, ErrorCallback);
    }
